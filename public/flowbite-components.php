...
<body>
    <header>
        <h1>Flowbite CSS</h1>
        <legend><a href="https://flowbite.com/docs/"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11h2v5m-2 0h4m-2.592-8.5h.01M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
          </svg> Documentation</a><br />
          <a href="https://flowbite.com/docs/getting-started/introduction/">Icones</a></legend>
    ...
    <main class="myContainer" class="container md mx-auto ">
        <section id="form1" class="sectionfb md">
            <h2><a href="https://flowbite.com/docs/components/forms/#checkbox">test</a></h2>
            <form class="max-w-sm mx-auto">
                ...
                <fieldset>      
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Etat (services publics)</label>
                    </div>
                    <div class="flex items-center mb-4">
                        <input id="checkbox-2" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Collectivités locales (commune, département, région)</label>
                    </div>                    
                    <div class="flex items-center mb-4">
                        <input id="checkbox-2" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Organisme d’habitations à loyer modéré (secteur public) </label>
                    </div>                    
                    <div class="flex items-center mb-4">
                        <input id="checkbox-2" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Organisme d’habitations à loyer modéré (secteur privé)</label>
                    </div>                    
                    <div class="flex items-center mb-4">
                        <input id="checkbox-2" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Syndicat de copropriétaires</label>
                    </div>                    
                    ...
                    <div class="flex mb-4">
                        ...
                        <div class="ms-2 text-sm">
                            <label for="helper-checkbox" class="font-medium text-gray-900 dark:text-gray-300">Vendeur privé d’immeuble à construire</label>
                            <p id="helper-checkbox-text" class="text-xs font-normal text-gray-500 dark:text-gray-400">Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum</p>
                        </div>
                    </div>              
        ...
        <section id="" class="sectionfb">
            ...
            <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
                <li class="mb-10 ms-6">            
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Validation de la DO n°123156 </h3>
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">30 avril 2024</time>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Assureur XXXXX 
                ...
                <li class="mb-10 ms-6">            
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Erreur de la DO n°123156 </h3>
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">30 avril 2024</time>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Document missing XXXXX 
                ...
                <li class="mb-10 ms-6">            
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Modification de la DO n°123156 </h3>
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">16 avril 2024</time>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Assureur XXXXX - complété à 75%
                ...
                <li class="mb-10 ms-6">            
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Création de la DO n°123156 </h3>
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">8 avril 2024</time>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Souscripteur XXXXX - complété à 50%
        ...
        <!-- -->
        <section id="info" class="sectionfb">
            <h2 class="sectionfb-title"><a href="">Infobulle</a>  
        ...
        <!-- Stepper-->
        <section id="stepper" class="sectionfb">
            <h2 class="sectionfb-title"><a href="https://flowbite.com/docs/components/stepper/">Stepper</a>           
            </h2>    
                ...
                <ol class="flex items-center">
                    ...
                    <li class="relative w-full mb-6">
                        <div class="flex items-center">
                            <div class="z-10 flex items-center justify-center w-6 h-6 bg-green-600 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">
                                <svg class="w-2.5 h-2.5 text-blue-100 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                                </svg>
                            </div>
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                <h2 id="accordion-collapse-heading-1">
                  <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-1" aria-expanded="false" aria-controls="accordion-collapse-body-1">
                    <span>Panneaux photovoltaïques <input type="checkbox" name="pv"/></span>
                ...
                <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                    <label class="inline-flex items-center cursor-pointer">
                        ...
                        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Oui</span>
                    </label>

                </div>
                <h2 id="accordion-collapse-heading-3">
                  <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
                    <span>Etude de sol</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                    </svg>
                  </button>
        ...
        <!-- table-->
        <section id="table" class="sectionfb">
            <h2 class="sectionfb-title"><a href="https://flowbite.com/docs/components/tables/">TABLES Doc</a></h2>
