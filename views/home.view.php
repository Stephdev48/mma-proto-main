...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 text-center lg:py-16">
        <h1 class="mb-4 text-3xl md:text-4xl lg:text-2xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white">Demande Ouvrage</h1>
        ...
        <textarea id="rgpd" rows="8" cols="80" class="mb-8 font-normal text-sm lg:text-lg text-gray-500 sm:px-4 lg:px-16 dark:text-gray-400">
            ...
            Vous disposez par ailleurs en cas de non-respect par La société Cabinet Cotton Alexandre à ses obli-gations au titre de la législation/réglementation en vigueur, du droit d'introduire une réclamation au-près de la Commission Nationale de l'Informatique et des Libertés (CNIL).
        </textarea>
        <div class="flex flex-col justify-center mb-4">
            <div>
                <input id="checkbox-home" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-400 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onclick="buttonActivate('start-button', 'checkbox-home')">
                <label for="checkbox-home" class="text-base font-medium text-gray-900 dark:text-gray-300">&nbsp;Lu et approuvé.</label>
            </div>
