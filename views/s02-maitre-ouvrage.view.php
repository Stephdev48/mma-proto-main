        ...
        <div class="my-16">
            ...
            <div class="flex flex-col lg:flex-row mx-6 mb-2">
                <div class="flex flex-col ml-8">
                    ...
                    <span><input type="radio" name="moa_qualite" value="entreprise" <?= isset($_SESSION['info_moa']['moa_qualite']) && ($_SESSION['info_moa']['moa_qualite'])=="entreprise" ? "checked=checked" : ""; ?> onclick="hideElement('moa_qualite_autre')"/> Enterprise</span>
