    ...
    <form action="" method="post">
        ...
        <div>
            <span class="text-gray-500 font-medium">Est-il situé dans une zone inondable ? &ensp;&ensp;
                <input type="radio" name="situation_zone_inond" value="1" <?= isset($_SESSION['info_situation']['situation_zone_inond'])==1 ? "checked=checked" : ""; ?> required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_zone_inond" value="0" <?= isset($_SESSION['info_situation']['situation_zone_inond'])==0 ? "checked=checked" : ""; ?>/>
                <label> Non</label>
            </span>  
        </div>
            <!-- Zone sismicité -->
        <div class="flex-column mt-16">
            ...
            <div class="ml-10 mt-2">
                <input type="radio" name="situation_sismique" value="1"/><label class="mr-6 text-sm lg:text-base" <?= isset($_SESSION['info_situation']['situation_sismique'])==1 ? "checked=checked" : ""; ?>> 1 (très faible)</label>
                <input type="radio" name="situation_sismique" value="2" <?= isset($_SESSION['info_situation']['situation_sismique'])==2 ? "checked=checked" : ""; ?>/><label class="mr-6 text-sm lg:text-base"> 2 (faible)</label>
                <input type="radio" name="situation_sismique" value="3" <?= isset($_SESSION['info_situation']['situation_sismique'])==3 ? "checked=checked" : ""; ?>/><label class="mr-6 text-sm lg:text-base"> 3 (modérée)</label>
                <input type="radio" name="situation_sismique" value="4" <?= isset($_SESSION['info_situation']['situation_sismique'])==4 ? "checked=checked" : ""; ?>/><label class="mr-6 text-sm lg:text-base"> 4 (moyenne)</label>
                <input type="radio" name="situation_sismique" value="5" <?= isset($_SESSION['info_situation']['situation_sismique'])==5 ? "checked=checked" : ""; ?>/><label class="text-sm lg:text-base"> 5 (forte)</label>
            </div>
        </div>
        ...
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Est-il situé dans une zone contaminée par les termites ou autres insectes xylophages ? &ensp;&ensp;
                <input type="radio" name="situation_insectes" value="1" <?= isset($_SESSION['info_situation']['situation_insectes'])==1 ? "checked=checked" : ""; ?> required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_insectes" <?= isset($_SESSION['info_situation']['situation_insectes'])==0 ? "checked=checked" : ""; ?> value="0"/>
                <label> Non</label>
            </span>  
        </div>
        ...
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Les travaux sont-ils réalisés avec des matériaux traditionnels ou selon des procédés de technique courante ? &ensp;&ensp;
                <input type="radio" name="situation_proc_techniques" value="1" <?= isset($_SESSION['info_situation']['situation_proc_techniques'])==1 ? "checked=checked" : ""; ?> required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_proc_techniques" value="0" <?= isset($_SESSION['info_situation']['situation_proc_techniques'])==0 ? "checked=checked" : ""; ?>/>
                <label> Non</label>
            </span>  
        </div>
            <!-- Parking -->
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Y a-t-il la présence d'un parking (accessoire de l'ouvrage) desservant l'ouvrage ? &ensp;&ensp;
                <input type="radio" name="situation_parking" value="1" <?= isset($_SESSION['info_situation']['situation_parking'])==1 ? "checked=checked" : ""; ?> required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_parking" value="0" <?= isset($_SESSION['info_situation']['situation_parking'])==0 ? "checked=checked" : ""; ?>/>
                <label> Non</label>
            </span>  
        </div>
            ...
            <h3 class="text-gray-500 font-medium">Si travaux sur une contruction existante ou sur existants :</h3>
                <div class="my-2 ml-10">
                    <span class="font-normal">Si les existants datent de moins de 10 ans, ont-ils fait l'objet d'un contrat d'assurance "dommages ouvrage" ? &ensp;&ensp;
                        <input type="radio" name="situation_do_10ans" value="1" <?= isset($_SESSION['info_situation']['situation_do_10ans'])==1 ? "checked=checked" : ""; ?> onclick="showElement('situation_do_10ans_contrat')" required/>
                        <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                        <input type="radio" name="situation_do_10ans" value="0" <?= isset($_SESSION['info_situation']['situation_do_10ans'])==0 ? "checked=checked" : ""; ?> onclick="hideElement('situation_do_10ans_contrat')"/>
                ...
                <div class="mt-4 ml-10">
                    <span class="font-normal">Les existants sont-ils classés monuments historiques ou font-ils l'objet d'une protection du patrimoine ? &ensp;&ensp;
                        <input type="radio" name="situation_mon_hist" value="1" <?= isset($_SESSION['info_situation']['situation_mon_hist'])==1 ? "checked=checked" : ""; ?> required/>
                        <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                        <input type="radio" name="situation_mon_hist" value="0" <?= isset($_SESSION['info_situation']['situation_mon_hist'])==0 ? "checked=checked" : ""; ?>/>
                        <label class="text-gray-500 font-medium"> Non</label>
                    </span>
                </div>
        </div>
        ...
        <div class="mt-16">
            ...
            <div class="my-2 ml-10">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'un label de performance énergétique (ex. BBC...) ? &ensp;&ensp;
                    <input type="radio" name="situation_label_energie" value="1" <?= isset($_SESSION['info_situation']['situation_label_energie'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_label_energie" value="0" <?= isset($_SESSION['info_situation']['situation_label_energie'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>  
            </div>
            <div class="my-2 ml-10">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'un label de qualité environnementale (ex. HQE...) ? &ensp;&ensp;
                    <input type="radio" name="situation_label_qualite" value="1" <?= isset($_SESSION['info_situation']['situation_label_qualite'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_label_qualite" value="0" <?= isset($_SESSION['info_situation']['situation_label_qualite'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
        </div>
        ...
        <div class="mt-20">
            ...
            <div class="flex flex-col lg:flex-row ml-10 mt-6">
                ...
                <div class="ml-8 text-gray-500 font-medium">
                    <input type="radio" name="situation_etude_sol" value="1" <?= isset($_SESSION['info_situation']['situation_etude_sol'])==1 ? "checked=checked" : ""; ?> onclick="showElement('situation_etude_sol_form')" required/>
                    <label> Oui &ensp;</label>
                    <input type="radio" name="situation_etude_sol" value="0" <?= isset($_SESSION['info_situation']['situation_etude_sol'])==0 ? "checked=checked" : ""; ?> onclick="hideElement('situation_etude_sol_form')"/>
                    <label> Non</label>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row mt-6">
                ...
                <div class="text-gray-500 font-medium">
                    <input type="radio" name="situation_etude_sol_parking" value="1" <?= isset($_SESSION['info_situation']['situation_etude_sol_parking'])==1 ? "checked=checked" : ""; ?> required/>
                    <label> Oui &ensp;</label>
                    <input type="radio" name="situation_etude_sol_parking" value="0" <?= isset($_SESSION['info_situation']['situation_etude_sol_parking'])==0 ? "checked=checked" : ""; ?>/>
                    <label> Non</label>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="ml-10 mt-2">
                ...
                <span class="text-sm font-normal ml-6">Dommages ouvrages obligatoire + dommages aux éléments d'équipement et immatériels &ensp;&ensp;
                    <input type="radio" name="situation_garanties_completes" value="1" <?= isset($_SESSION['info_situation']['situation_garanties_completes'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_garanties_completes" value="0" <?= isset($_SESSION['info_situation']['situation_garanties_completes'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
        ...
        <div class="flex-column mt-16">
            ...
            <div class="ml-10 mt-2">
                <span class="font-normal">S'agit-il d'une construction en bois ? &ensp;&ensp;
                    <input type="radio" name="situation_construction_bois" value="1" <?= isset($_SESSION['info_situation']['situation_construction_bois'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_construction_bois" value="0" <?= isset($_SESSION['info_situation']['situation_construction_bois'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">Y a-t-il la présence de panneaux photovoltaïques ? &ensp;&ensp;
                    <input type="radio" name="situation_pann_photo" value="1" <?= isset($_SESSION['info_situation']['situation_pann_photo'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_pann_photo" value="0" <?= isset($_SESSION['info_situation']['situation_pann_photo'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'une installation géothermique ? &ensp;&ensp;
                    <input type="radio" name="situation_geothermie" value="1" <?= isset($_SESSION['info_situation']['situation_geothermie'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_geothermie" value="0" <?= isset($_SESSION['info_situation']['situation_geothermie'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">Y a-t-il intervention d'un contrôleur technique ? &ensp;&ensp;
                    <input type="radio" name="situation_controle_tech" value="1" <?= isset($_SESSION['info_situation']['situation_controle_tech'])==1 ? "checked=checked" : ""; ?> required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_controle_tech" value="0" <?= isset($_SESSION['info_situation']['situation_controle_tech'])==0 ? "checked=checked" : ""; ?>/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
        </div>
