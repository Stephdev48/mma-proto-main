    ...
    <div class="mt-20">
        ...
        <div class="flex flex-col lg:flex-row ml-10 mt-6">
            ...
            <div class="ml-8 text-gray-500 font-medium">
                <input type="radio" name="etude-sol" id="check-yes" onclick="radioFormOpen('etude-sol-form')"/>
                <label for="etude-sol"> Oui &ensp;</label>
                <input type="radio" name="etude-sol" id="check-no" onclick="radioFormClose('etude-sol-form')"/>
        ...
        <div id="etude-sol-form" class="hidden px-8 py-4">
            ...
            <div class="flex flex-col lg:flex-row mt-16">
                ...
                <div class="text-gray-500 font-medium">
                    <input type="radio" name="etude-sol-parking"/>
