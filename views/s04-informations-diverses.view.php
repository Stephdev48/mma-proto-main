    ...
    <form action="" method="post">
        ...
        <div>
            <span class="text-gray-500 font-medium">Est-il situé dans une zone inondable ? &ensp;&ensp;
                <input type="radio" name="situation_zone_inond" value="1" required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_zone_inond" value="0"/>
                <label> Non</label>
            </span>  
        </div>
            <!-- Zone sismicité -->
        <div class="flex-column mt-16">
            ...
            <div class="ml-10 mt-2">
                <input type="radio" name="situation_sismique" value="1"/><label class="mr-6 text-sm lg:text-base"> 1 (très faible)</label>
                <input type="radio" name="situation_sismique" value="2"/><label class="mr-6 text-sm lg:text-base"> 2 (faible)</label>
                <input type="radio" name="situation_sismique" value="3"/><label class="mr-6 text-sm lg:text-base"> 3 (modérée)</label>
                <input type="radio" name="situation_sismique" value="4"/><label class="mr-6 text-sm lg:text-base"> 4 (moyenne)</label>
                <input type="radio" name="situation_sismique" value="5"/><label class="text-sm lg:text-base"> 5 (forte)</label>
            </div>
        </div>
        ...
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Est-il situé dans une zone contaminée par les termites ou autres insectes xylophages ? &ensp;&ensp;
                <input type="radio" name="situation_insectes" value="1" required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_insectes" value="0"/>
                <label> Non</label>
            </span>  
        </div>
        ...
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Les travaux sont-ils réalisés avec des matériaux traditionnels ou selon des procédés de technique courante ? &ensp;&ensp;
                <input type="radio" name="situation_proc_techniques" value="1" required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_proc_techniques" value="0"/>
                <label> Non</label>
            </span>  
        </div>
            <!-- Parking -->
        <div class="mt-16">
            <span class="text-gray-500 font-medium">Y a-t-il la présence d'un parking (accessoire de l'ouvrage) desservant l'ouvrage ? &ensp;&ensp;
                <input type="radio" name="situation_parking" value="1" required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="situation_parking" value="0"/>
                <label> Non</label>
            </span>  
        </div>
            ...
            <h3 class="text-gray-500 font-medium">Si travaux sur une contruction existante ou sur existants :</h3>
                <div class="my-2 ml-10">
                    <span class="font-normal">Si les existants datent de moins de 10 ans, ont-ils fait l'objet d'un contrat d'assurance "dommages ouvrage" ? &ensp;&ensp;
                        <input type="radio" name="situation_do_10ans" value="1" onclick="showElement('situation_do_10ans_contrat')" required/>
                        <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                        <input type="radio" name="situation_do_10ans" value="0" onclick="hideElement('situation_do_10ans_contrat')"/>
                ...
                <div class="mt-4 ml-10">
                    <span class="font-normal">Les existants sont-ils classés monuments historiques ou font-ils l'objet d'une protection du patrimoine ? &ensp;&ensp;
                        <input type="radio" name="situation_mon_hist" value="1" required/>
                        <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                        <input type="radio" name="situation_mon_hist" value="0"/>
                        <label class="text-gray-500 font-medium"> Non</label>
                    </span>
                </div>
        </div>
        ...
        <div class="mt-16">
            ...
            <div class="my-2 ml-10">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'un label de performance énergétique (ex. BBC...) ? &ensp;&ensp;
                    <input type="radio" name="situation_label_energie" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_label_energie" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>  
            </div>
            <div class="my-2 ml-10">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'un label de qualité environnementale (ex. HQE...) ? &ensp;&ensp;
                    <input type="radio" name="situation_label_qualite" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_label_qualite" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
        </div>
        ...
        <div class="mt-20">
            ...
            <div class="flex flex-col lg:flex-row ml-10 mt-6">
                ...
                <div class="ml-8 text-gray-500 font-medium">
                    <input type="radio" name="situation_etude_sol" value="1" onclick="showElement('situation_etude_sol_form')" required/>
                    <label> Oui &ensp;</label>
                    <input type="radio" name="situation_etude_sol" value="0" onclick="hideElement('situation_etude_sol_form')"/>
                    <label> Non</label>
                </div>
            </div>
            <div id="situation_etude_sol_form" class="hidden px-8 py-4">
                ...
                <div class="flex flex-col lg:flex-row ml-24 mt-2">
                    ...
                    <div class="flex flex-row ml-8 text-gray-500 font-medium mt-2">
                        <span><input type="radio" name="situation_etude_sol_bureau_mission" value="g2_amp" onclick="hideElement('situation_etude_sol_bureau_mission_autre')"/> G2 AMP</span>
                        <span class="ml-6"><input type="radio" name="situation_etude_sol_bureau_mission" value="g2_pro" onclick="hideElement('situation_etude_sol_bureau_mission_autre')"/> G2 Pro</span>
                        <span class="ml-6"><input type="radio" name="situation_etude_sol_bureau_mission" value="etude_sol_autre" onclick="showElement('situation_etude_sol_bureau_mission_autre')"/> Autre </span>
                    </div>
            ...
            <div class="flex flex-col lg:flex-row mt-6">
                ...
                <div class="text-gray-500 font-medium">
                    <input type="radio" name="situation_etude_sol_parking" value="1" required/>
                    <label> Oui &ensp;</label>
                    <input type="radio" name="situation_etude_sol_parking" value="0"/>
                    <label> Non</label>
                </div>
            </div>
        </div>
        ...
        <div class="flex-column mt-16">
            ...
            <div class="ml-10 mt-2">
                <span class="font-normal">S'agit-il d'une construction en bois ? &ensp;&ensp;
                    <input type="radio" name="situation_construction_bois" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_construction_bois" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">Y a-t-il la présence de panneaux photovoltaïques ? &ensp;&ensp;
                    <input type="radio" name="situation_pann_photo" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_pann_photo" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">L'opération de construction bénéficie-t-elle d'une installation géothermique ? &ensp;&ensp;
                    <input type="radio" name="situation_geothermie" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_geothermie" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
            <div class="ml-10 mt-2">
                <span class="font-normal">Y a-t-il intervention d'un contrôleur technique ? &ensp;&ensp;
                    <input type="radio" name="situation_controle_tech" value="1" required/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="situation_controle_tech" value="0"/>
                    <label class="text-gray-500 font-medium"> Non</label>
                </span>
            </div>
        </div>
        ...
        <div class="flex flex-row justify-center mt-16">
            ...
            <div class="text-center ml-6">
                <button type="submit" name="send_step4" value="step4" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-32 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Suivant</button>
            </div>
        </div>
