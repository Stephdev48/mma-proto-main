    ...
    <div class="">
        ...
        <div class="flex flex-col lg:flex-row ml-10 mt-6">
            ...
            <div class="ml-8 text-gray-500 font-medium">
                <input type="radio" name="moe_intervention" value="1" <?= $_SESSION['info_moe']['moe_intervention']==1 ? "checked=checked" : ""; ?> onclick="showElement('moe_intervention_form')" required/>
                <label> Oui &ensp;</label>
                <input type="radio" name="moe_intervention" value="0" <?= $_SESSION['info_moe']['moe_intervention']==0 ? "checked=checked" : ""; ?> onclick="hideElement('moe_intervention_form')"/>
                <label> Non</label>
            </div>
        </div>
        <div id="moe_intervention_form" class="hidden px-8 py-4">
            ...
            <div class="flex mt-16">
                ...
                <div class="ml-10">
                    <input type="radio" name="moe_intervention_independant" value="1" <?= $_SESSION['info_moe']['moe_intervention_independant']==1 ? "checked=checked" : ""; ?> onclick="hideElement('moe_intervention_independant_info')"/>
                    <label class="text-gray-500 font-medium"> Oui &ensp;</label>
                    <input type="radio" name="moe_intervention_independant" value="0" <?= $_SESSION['info_moe']['moe_intervention_independant']==0 ? "checked=checked" : ""; ?> onclick="showElement('moe_intervention_independant_info')"/>
        ...
        <div id="moe_intervention_independant_info" class="hidden px-8 py-4">
            ...
            <div class="ml-10 mt-4">
                ...
                <div class="ml-10">
                    <div>
                        <input type="radio" name="moe_intervention_independant_mission" value="conception" <?= $_SESSION['info_moe']['moe_intervention_independant_mission']=="conception" ? "checked=checked" : ""; ?>>
                        <label class="font-normal">Conception</label>
                    </div>
                    <div>
                        <input type="radio" name="moe_intervention_independant_mission" value="direction" <?= $_SESSION['info_moe']['moe_intervention_independant_mission']=="direction" ? "checked=checked" : ""; ?>>
                        <label class="font-normal">Direction et surveillance des travaux</label>
                    </div>
                    <div>                
                        <input type="radio" name="moe_intervention_independant_mission" value="complete" <?= $_SESSION['info_moe']['moe_intervention_independant_mission']=="complete" ? "checked=checked" : ""; ?>>
                        <label class="font-normal">Mission complète</label>
                    </div>
                    <div>                  
                        <input type="radio" name="moe_intervention_independant_mission" value="autre" <?= $_SESSION['info_moe']['moe_intervention_independant_mission']=="autre" ? "checked=checked" : ""; ?>>
