<?php
    ...
    if (isset($_POST['send-step1'])) {
        ...
        header('Location: ../index.php?page=step2.php');
	}
...
<!-- Stepper -->
<section id="stepper" class="sectionfb mt-16"> 
...
<form action="" method="post" class="max-w-md mx-auto mt-16">
  ...
  <button type="submit" value="send-step1" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Envoyer</button>
</form>
